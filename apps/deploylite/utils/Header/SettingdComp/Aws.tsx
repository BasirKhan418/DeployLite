    ...
    <div>
      ...
      <Card>
                <CardHeader>
                  ...
                  <CardDescription>Connect and manage your AWS,GCP and Azure services to deploy your application.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{isconnected?"Connected":"Connect Now"}</p>
                      </div>
                    </div>
                    {isconnected&&<Button variant={'outline'} onClick={()=>{
                      setAlertOpen(true)
                    }}>{loading?<LoginLoader/>:<ButtonDisc/>}</Button>}
                  ...
                  <Button onClick={()=>{
                  toast.info("This feature is not available yet.Try to connect with AWS .")
                  }}>Connect Now</Button>
                  </div>
                  <Separator />
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <SiMicrosoftazure className="w-8 h-8 text-primary" />
                      <div>
                 ...
                 {isconnected&&<><div className="space-y-2">
                    ...
                    <Input id="awsAccessKey" placeholder="Enter your AWS Access Key ID" value={aws.awskey} readOnly/>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="awsSecretKey">AWS Secret Access Key</Label>
                    <Input id="awsSecretKey" type="password" placeholder="Enter your AWS Secret Access Key" value={aws.awssecret} readOnly/>
                  </div></>}
                </CardContent>
               { isconnected&&<CardFooter>
                  <Button onClick={()=>{
                    setisUpdate(true)
                    setOpen(true)
                  }}>Update AWS Configuration</Button>
                </CardFooter>}
              </Card>
              ...
              {isconnected&&<Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="s3Service" defaultChecked={!!aws.s3} onCheckedChange={()=>{
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="ec2Service" defaultChecked={!!aws.ec2} onCheckedChange={()=>{
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Run Containers without Managing Infrastructure</p>
                    </div>
                    <Switch id="rdsService" defaultChecked={!!aws.fargate} onCheckedChange={()=>{
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">Amazon ECS (Elastic Container Service)</p>
                      <p className="text-sm text-muted-foreground">Highly secure, reliable, and scalable way to run containers</p>
                    </div>
                    <Switch id="rdsService" defaultChecked={!!aws.ecs} onCheckedChange={()=>{
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">Amazon ECR (Elastic Container Registry)</p>
                      <p className="text-sm text-muted-foreground">Fully-managed Docker container registry : Share and deploy container software</p>
                    </div>
                    <Switch id="rdsService" defaultChecked={!!aws.ecr} onCheckedChange={()=>{
