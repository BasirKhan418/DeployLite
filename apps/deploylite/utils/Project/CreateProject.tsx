    ...
    <div className="min-h-screen  py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="shadow-xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-gray-900 dark:text-gray-100">New Project Setup</CardTitle>
          ...
          <CardContent>
            <Tabs value={`stage-${stage}`} className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="stage-2" onClick={() => setStage(2)} disabled={stage < 2}>Select Plan</TabsTrigger>
                <TabsTrigger value="stage-3" onClick={() => setStage(3)} disabled={stage < 3}>Review</TabsTrigger>
              </TabsList>
