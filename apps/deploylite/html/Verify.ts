const Verify = ()=>{
    let template = `<html>
    <head>
    <title> Email Verification Confirmation | DeployLite</title>
    <style>
...
button:hover {
  ...
  <div class="contentAlert">
    ...
    <div class="bottomHalf">
      ...
      <p>Well Done!, Thank you for verifying your email address. Your account is now active.</p>

      <a id="alertMO" href="/login">Click here to login </a>
