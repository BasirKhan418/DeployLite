          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                ...
                <p className="text-white/70 text-lg">Seamlessly deploy across multiple technologies with full support for databases and an integrated web builder — everything you need in one platform.</p>
              </div>
            </div>
          </CardWithEffect>
          <CardWithEffect>
