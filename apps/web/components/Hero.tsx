...
export const Hero = () => {
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip lg:top-16 md:top-16 top-16 flex justify-center items-center">
    ...
    <div className="container relative top-6">
      ...
      <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>Deploy<br/> Smarter</h1>
      ...
      <p className='text-xl text-center mt-8 max-w-md'>DeployLite makes code deployment effortless and efficient.
