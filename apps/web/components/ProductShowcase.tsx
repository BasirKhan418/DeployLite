...
const opacity = useTransform(scrollYProgress, [0, 1], [.3,1]);
  ...
  return (
    <div className="bg-black text-white bg-gradient-to-b from-black to-[#5D2CA8] py-[72px] sm:py-24 flex justify-center items-center">
      <div className="container">
        ...
        >
        <Image src={appScreen}  ref={appImage} alt="app screen" className="mt-14" height={800} width={800}/>
        </motion.div>
        </div>
