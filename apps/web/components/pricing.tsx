    ...
    <div>
      ...
      <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
        ...
        <PricingTab
          ...
          planDescription="Start building and deploying for free, ideal for personal projects."
          features={[
            '1 Project',
            '100GB bandwidth',
        ...
        <PricingTab
          ...
          planDescription="For professional developers and small teams. Get more power and features."
          features={[
            '5 Projects',
            '1TB bandwidth',
            'Custom domains',
        ...
        <PricingTab
          yearly={isAnnual}
          planName="Enterprise"
          price={{ yearly: 50, monthly: 60 }}
          planDescription="For larger teams with high performance needs. Secure and scalable."
          features={[
            'Unlimited Projects',
            '5TB bandwidth',
